  ...
  const getMenuItems = (): MenuItem[] => {
    ...
    if (dashboardType === 'librarian') {
      return [
        ...
        { id: 'active-borrowings', label: 'Peminjaman Aktif', icon: <BookOpen className="w-5 h-5" /> },
